...
- **223 scenarios** in `test_scenarios_complete.json`. Each scenario is a
...
`.github/workflows/cross-sdk.yml` runs the full 223-scenario suite for all 21
...
├── test_scenarios_complete.json  # 223 scenarios
